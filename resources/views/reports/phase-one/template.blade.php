...
<div class="report-document">
    ...
    <section class="report-page"><h2>Tu primera lectura</h2><div class="report-gray">@foreach ($report['shared']['intro'] as $paragraph)<p>{!! $paragraph !!}</p>@endforeach</div><div class="report-arrow-title">LAS CUATRO PUERTAS</div><div class="report-gray">@foreach ($report['shared']['states'] as $paragraph)<p>{!! $paragraph !!}</p>@endforeach</div><div class="report-arrow-title">CONCLUSIONES IMPORTANTES PARA TU LECTURA</div><div class="report-gray">@foreach ($report['shared']['conclusions'] as $paragraph)<p>{!! $paragraph !!}</p>@endforeach</div></section>
    <section class="report-page"><h2>Una breve introducción a tus cuatro puertas</h2><table class="report-table"><tr><th>Puerta</th><th>Posición</th><th>Pregunta</th></tr>@foreach ($report['doors'] as $door)@php $context = $door['blocks']['sign'][0] ?? ''; @endphp<tr><td>{{ $door['title'] }}</td><td>{!! $context !!}</td><td>{{ $door['question'] }}</td></tr>@endforeach</table><div class="report-arrow-title">ESTADOS DE CADA PUERTA</div><div class="report-gray">@foreach ($report['shared']['states'] as $paragraph)<p>{!! $paragraph !!}</p>@endforeach</div></section>
