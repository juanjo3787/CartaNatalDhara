...
<tr>
	...
	<td>@if (! $generation->ai_assisted)<a href="{{ route('charts.report.download', $chart) }}">Descargar actual</a>@elseif ($generation->system_prompt)<a href="{{ route('charts.report.prompts', [$chart, $generation]) }}">Ver prompts</a>@else - @endif</td>
</tr>
@empty
