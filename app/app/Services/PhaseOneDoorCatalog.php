...
final class PhaseOneDoorCatalog
{
    ...
    {
        $prefix = match ($door) {
            'sol' => ['harmony' => ['Expresar una preferencia propia', 'Escuchar sin abandonar el criterio', 'Elegir una colaboración equilibrada', 'Reconocer el valor de la propia contribución', 'Ocupar espacio sin imponerse', 'Revisar una decisión con información nueva', 'Sostener una responsabilidad elegida'], 'deficit' => ['Dejar tu opinión fuera de la decisión', 'Evitar una conversación que podría aclarar', 'Pedir menos reciprocidad de la que necesitas', 'Infravalorar tu contribución', 'Confundir discreción con no ocupar espacio', 'Retirarte antes de comprobar si se puede colaborar', 'Vivir en respuesta de las obligaciones'], 'excess' => ['Adaptarte hasta perder tu posición', 'Necesitar agradar para sentirte coherente', 'Sostener todas las tensiones del entorno', 'Convertir el compromiso en una prueba de lealtad', 'Buscar el acuerdo perfecto', 'Ofrecer más para asegurar tu lugar', 'Guardar la cuenta de las concesiones']],
