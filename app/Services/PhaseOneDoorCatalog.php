...
final class PhaseOneDoorCatalog
{
    ...
    private function solHouseSix(array $context): array
    {
        ...
        return [
            ...
            'Con tu Sol en casa VI, el desarrollo personal puede encontrar oportunidades en mejoras pequeñas y concretas: aprender algo que te interesa, resolver con más claridad una dificultad o modificar una rutina que ya no encaja. Para observar esta casa: dar continuidad a una habilidad; revisar hábitos; comprobar las condiciones de una tarea; hacer visible el tiempo de coordinación; elegir formas de ayuda claras; incluir pausas e imprevistos; y reconocer cuándo algo está suficientemente bien.',
        ];
    }
    ...
    private function solVenusRuler(array $context): array
    {
        return [
            ...
            'Pautas: identifica qué hace valioso un vínculo; deja que la confianza avance al ritmo de lo vivido; observa qué ocurre después de un error; expresa qué gestos te hacen sentir querida; y separa el hecho de la interpretación afectiva que le has dado.',
        ];
    }
    ...
    private function lunaSolRuler(array $context): array
    {
        return [
            ...
            'Pautas: poner palabras a la emoción; pedir un gesto concreto; observar si el cuidado es puntual o repetido; distinguir ayudar de recibir; y revisar una rutina que esté informando de agotamiento.',
        ];
    }
    ...
    private function ascendantVenusRuler(array $context): array
    {
        return [
            ...
            'Pautas: comprobar qué merece la pena antes de comprometerte; observar hechos repetidos; conservar el ritmo propio; distinguir compromiso de control; y revisar si la forma de comenzar sigue cuidando tus valores actuales.',
        ];
    }
    ...
    private function descendantRulers(array $context): array
    {
        return [
            ...
            'Pautas: aclara qué parte es un hecho y cuál una interpretación; expresa el acuerdo que necesitas; revisa quién decide y quién asume lo pendiente; conserva la posibilidad de renegociar; y respeta la privacidad que no te corresponde dirigir.',
        ];
    }
